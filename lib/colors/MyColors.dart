...
class MyColors
{
  ...
  static Color colorDarkPrimary = Color(0xff445e3b);
  static Color colorPrimary = Color(0xff58835d);
  static Color colorLightPrimary = Color(0xffa3d5a0);
  static Color colorDarkSecondary = Color(0xff48484a);
  static Color colorSecondary = Color(0xffa3a4a8);
  static Color colorLightSecondary = Color(0xffcecfd1);
